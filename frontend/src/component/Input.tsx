  ...
  ({ label, error, ...rest }, ref) => {
    return (
      <div className="relative w-full lg:w-[30rem]">
        <input
          ref={ref}
          className="outline-none px-3 py-5 border-2 border-neutral-300 w-full rounded-md peer focus:border-orange-500 disabled:bg-neutral-300 placeholder-transparent"
          {...rest}
        />
